      ...
      {start ? (
        ...
        >
          ...
          <div className="w-full min-h-screen relative">
            {imageLoaded && (
              <img className="w-full h-full object-cover  min-h-screen" src={fondo} alt="" />
            )}
            <div className="absolute inset-0 bg-black/15"></div>

            <main className="w-full  text-white absolute top-[25vh] left-0 right-0   z-40">
              ...
              <div className="max-w-7xl px-4 mx-auto">
                <p className="text-center text-lg sm:text-xl md:text-2xl lg:text-3xl py-2">
                  En Aura, convertimos cada espacio en una experiencia única,
                  fusionando creatividad, funcionalidad y confort.
                </p>
              </div>
              <div className="max-w-7xl mx-auto flex items-center justify-around lg:justify-baseline text-center py-4 md:text-xl">
